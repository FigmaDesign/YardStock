...
export default function FeaturedCard({
  ...
  return (
    ...
    >
      ...
      />
      <div
        className="absolute inset-0 bg-linear-to-br from-[var(--ys-ink)]/92 via-[var(--ys-ink-soft)]/85 to-[var(--ys-ink)]/70"
        aria-hidden="true"
      />
      <div
      ...
      <div className="relative z-10 flex flex-col justify-between p-4 sm:p-6 h-full min-h-[220px] sm:min-h-[280px]">
        <div className="flex">
          <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-[0.7rem] font-bold uppercase tracking-widest bg-[var(--ys-accent-orange)]/90 text-white backdrop-blur-md shadow-md shadow-[var(--ys-accent-orange)]/30 outline outline-1 outline-[var(--ys-accent-light)]/50">
