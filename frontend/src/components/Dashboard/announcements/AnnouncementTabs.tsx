        ...
        return (
          <button
            ...
            className={[
              ...
              'focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--ys-primary)] focus-visible:ring-inset',
              'motion-reduce:transition-none motion-reduce:transform-none',
              idx !== 0 ? 'border-l border-solid border-[var(--ys-mute)]/50' : '',
              !isActive ? 'hover:bg-[var(--ys-ink)]/3' : '',
            ].join(' ')}
          >
            <Icon
              size={18}
            ...
            <span
              className={`text-center text-[0.55rem] @md:text-xs leading-[1.1] whitespace-normal wrap-break-word transition-all duration-200 motion-reduce:transition-none ${
                isActive ? 'font-bold text-[var(--ys-ink)]' : 'font-medium text-[var(--ys-body-mid)]'
              }`}
            >
            ...
            {isActive && (
              <div
                aria-hidden="true"
                className="absolute bottom-0.75 left-1/2 h-0.75 w-3/4 -translate-x-1/2 rounded-[8px] bg-linear-to-r from-[var(--ys-primary)] to-[var(--ys-ink-mid)]"
              />
            )}
          </button>
        )
