  ...
  return (
    <section aria-label="Recent Properties Loading" className="ys-fade-in-up motion-reduce:animate-none motion-reduce:transform-none motion-reduce:opacity-100 [animation-delay:180ms]">
      <div
        ...
        className="ys-skeleton rounded-xl overflow-hidden h-64 border border-[var(--ys-mute)] bg-gradient-to-br from-[var(--ys-canvas)] to-[var(--ys-canvas-soft)] shadow-[0_2px_10px_rgba(0,0,0,0.03)]"
      />
    </section>
  )
})
  ...
  return (
    <section aria-label="Activity Feed Loading" className="ys-fade-in-up motion-reduce:animate-none motion-reduce:transform-none motion-reduce:opacity-100 [animation-delay:260ms]">
      <div
        ...
        className="ys-skeleton rounded-xl h-64 border border-[var(--ys-mute)] bg-gradient-to-br from-[var(--ys-canvas)] to-[var(--ys-canvas-soft)] shadow-[0_2px_10px_rgba(0,0,0,0.03)]"
      />
    </section>
  )
})
...
function DesktopDashboard() {
  ...
  return (
    <main className="flex flex-col h-full overflow-hidden bg-gradient-to-br from-[var(--ys-canvas)] to-[var(--ys-canvas-soft)]">
      ...
      <div className="flex-1 overflow-hidden flex flex-col focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-[var(--ys-accent-orange)]" tabIndex={-1}>
        {activeTab === 'announcements' ? (
          ...
          <div className="flex-1 overflow-y-auto px-6 py-6">
            <header className="mb-6">
              <p className="text-[0.7rem] font-semibold text-[var(--ys-body)] uppercase tracking-widest truncate">
                {activeItem?.label ?? 'Dashboard'}
              </p>
              <h2 className="text-[1.5rem] font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-[var(--ys-ink)] to-[var(--ys-ink-soft)] mt-1 truncate">
                {activeSubTab}
              </h2>
            </header>
            <StatCards />
...
function MobileDashboard() {
  ...
  return (
    <main className="h-full flex flex-col overflow-hidden bg-gradient-to-br from-[var(--ys-canvas)] to-[var(--ys-canvas-soft)]">
      ...
      <div className="flex-1 overflow-hidden flex flex-col [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] scrollbar-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-[var(--ys-accent-orange)]" tabIndex={-1}>
        {activeTab === 'announcements' ? (
          <Announcements />
        ) : activeTab === 'podcasts' ? (
          <Podcasts activeSubTab={activeSubTab} />
          ...
          <div className="flex-1 overflow-y-auto px-4 py-5">
            <header className="mb-5">
              <p className="text-[0.65rem] font-semibold text-[var(--ys-body)] uppercase tracking-widest truncate">
                {activeItem?.label ?? 'Dashboard'}
              </p>
              <h2 className="text-[1.2rem] font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-[var(--ys-ink)] to-[var(--ys-ink-soft)] mt-1 truncate">
                {activeSubTab}
              </h2>
            </header>
            <StatCards />
